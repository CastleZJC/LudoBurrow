...
**当前状态（2026-09-14 基线）**：一期（M1-M6）全部完成（v1.0.0 发布，验收返工迭代至 v1.1.0，后续验收成果随下版发布）；当前门禁：typecheck 0 错、574 tests、coverage 94.25%（branches 90.48%）、i18n 163 键。二期已排期（Web 登录与素材隔离 + iOS 移动端支持 + 横竖屏布局自适应），Web 分叉框架已预留。
